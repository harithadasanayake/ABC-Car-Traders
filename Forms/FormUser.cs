                ...
                if (txtPassword.Text == txtComPassword.Text)
                {
                    ...
                    else
                    {
                        try
                        {
                            ...
                            new DataSet.ABCTradersTableAdapters.UsersTableAdapter().UserRegister(txtName.Text, txtUsername.Text, txtEmail.Text, int.Parse(txtContact.Text), txtNIC.Text, txtAddress.Text, listBoxUserType.Text, passwordHash);
                            txtName.Text = "";
                            txtUsername.Text = "";
                            txtEmail.Text = "";
                            txtContact.Text = "";
                ...
                if (password == compassword)
                {
                    ...
                    if (dr == DialogResult.Yes)
                    {
                        try
                        {
                            ...
                            new DataSet.ABCTradersTableAdapters.UsersTableAdapter().UpdateUser(name, username, email, mobile, nic, address, usertype, passwordHash, id);
