            ...
            else
            {
                if (txtPassword.Text == txtComPassword.Text)
                {
                    ...
                    else
                    {
                        ...
                        new DataSet.ABCTradersTableAdapters.UsersTableAdapter().UserRegister(txtName.Text, txtUsername.Text, txtEmail.Text, int.Parse(txtContact.Text), txtNIC.Text, txtAddress.Text, "Customer", passwordHash);
                        txtName.Text = "";
                        txtUsername.Text = "";
                        txtEmail.Text = "";
                        txtContact.Text = "";
