...
namespace ABC_traders.Forms
{
    public partial class UserParts : Form
    {
        ...
        private void Restore()
        {
            ...
            picPart.Image = ABC_traders.Properties.Resources.car_parts_animation_1_removedbg;
            txtQnt.Enabled = true;
            LoadParts();
        }
        ...
        private void btnBuy_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.Yes)
            {
                ...
                {
                    MessageBox.Show("There are no car data saved on this ID! Please Conatct Customer Care : 0117890990", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
